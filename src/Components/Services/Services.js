...
const Services = () => {
  ...
  return (
    <Container title={"Services"} renderDescription={() => <h1 className="about-heading">
      Unique and reliable <br /> technology &nbsp;
      <span className="blue-text">solutions</span> assured
    </h1>} renderBody={() => <div className="services-sticky space-service">
      ...
      renderExtra={() => <div className="quest-container">
