        ...
        <div className="page-spacing__large is-track-record bg--4 radius-24">
          <div className="container-small">
            ...
            <h2 className="service-heading">
              Unique And Reliable Technology &nbsp;
              <span className="project-span">Solutions &nbsp;</span>
              Assured
            </h2>
                    ...
                    <div className="services-track">
                      <div className="services__wrapper">
                        <div className="w-dyn-list">
                          ...
                          <div
                            role="listitem"
                            className="service-item w-dyn-item center-service"
                          >
                            <a
                              data-w-id="52d8cbef-9526-9dca-e171-165f7a27a1cc"
                              href="/services/market-sizing-and-forecasting"
                          ...
                          <div className="p-body quest-text ">
                          ...
                          >
                            <a href="/contact-us" className="new-buttonn">
                              <div className="black-background"></div>

                              <div className="text-rotaotr is-inside">
                                <div className="nav-text text-4">
                                  Get in touch
                                </div>
                              </div>
