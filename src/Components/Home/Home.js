...
const Home = () => {
  ...
  useEffect(() => {
    ...
    staggerLinks.forEach((link) => {
      ...
      const arrows = link.querySelectorAll(".nav_main-arrow");
                  ...
                  <div className="home__about-wrapper-inner">
                    ...
                    <div className="column-50 flex-vertical">
                      ...
                      >
                        ...
                        specializing in <span text-split-blue="" className="word" text-split="" style={{ color: '#69D3DB' }}>engineering</span> <span> &nbsp; </span>  unique products and
          ...
          <div className="space-top radius-36" style={{ width: '100%' }}>
            <div className="logos__inner-wrapper">
              <div className="logo__heading">
                <h2 className="nav_fontsize-34 text-3 line-height-1-1 is-logos">
                  Who trusts us?
                </h2>
              </div>
              <div
              ...
              >
                ...
                >
                  ...
                  >
                    <div className="logo-wrapper w-embed">
                      <img src={"/partners/zain.png"} alt="Logo" />
                    </div>
                  </div>
                </div>
                <div
              ...
              >
                ...
                >
                  ...
                  >
                    <div className="logo-wrapper w-embed">
                      <img src={"/partners/site.png"} alt="Logo" />
                    </div>
                  </div>
                </div>
                <div
              ...
              >
                ...
                >
                  ...
                  >
                    <div className="logo-wrapper w-embed">
                      <img src={"/partners/emaar.png"} alt="Logo" />
                    </div>
                  </div>
                </div>
                <div
              ...
              >
                ...
                >
                  ...
                  >
                    <div className="logo-wrapper w-embed">
                      <img src={"/partners/tahkum.png"} alt="Logo" />
                    </div>
                  </div>
                </div>
                <div
              ...
              >
                ...
                >
                  ...
                  >
                    <div className="logo-wrapper w-embed">
                      <img src={"/partners/shomoul.png"} alt="Logo" />
                    </div>
                  </div>
                </div>
                <div
              ...
              >
                <div className="logos-change-wrapper is-oposite">
                  ...
                  >
                    <div className="logo-wrapper w-embed">
                      <img src={"/partners/saudia-downtown.png"} alt="Logo" />
                    </div>
                  </div>
                  <div
                    style={{
              ...
              >
                <div className="logos-change-wrapper is-oposite">
                  ...
                  >
                    <div className="logo-wrapper w-embed">
                      <img src={"/partners/siraar.png"} alt="Logo" />
                    </div>
                  </div>
                  <div
                    style={{
              ...
              >
                ...
                >
                  ...
                  >
                    <div className="logo-wrapper w-embed">
                      <img src={"/partners/jotun.png"} alt="Logo" />
                    </div>
                  </div>
                </div>
                <div
              ...
              <div
                data-w-id="d028ce38-b804-de18-8480-4aa4e1dcf3b5"
                className="logo__double bg-dark"
              >
                <div
                  style={{
                    width: '16em',
                ...
                >
                  ...
                  >
                    <div className="logo-wrapper w-embed" >
                      <img src={"/partners/world-stage-management.png"} alt="Logo" />
                    </div>
                  </div>
                </div>
                <div
              ...
              >
                ...
                >
                  ...
                  >
                    <div className="logo-wrapper w-embed" >
                      <img src={"/partners/ge-healthcare.png"} alt="Logo" />
                    </div>
                  </div>
                </div>
                <div
              ...
              <div className="logo__heading-brand flex-row justfiy-space-between">
                ...
                <div className="logo__single-brand-partner bg-dark">
                  <div
                    ...
                    className="logo__single-wrapper is-1"
                  >
                    <img src={"/partners/brand-partner.png"} />
                  </div>
                </div>
              </div>
            </div>
